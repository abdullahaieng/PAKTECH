...
import { api, type Category } from "@/lib/admin/api";
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[var(--admin-muted)] mt-1">{categories.length} categories</p>
        </div>
        <button
            ...
            <div key={cat.id} className="bg-white rounded-xl border p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-[var(--admin-muted)] mt-1">{cat.slug}</p>
              ...
              <p className="text-xs text-[var(--admin-muted)] mt-3 line-clamp-2">{cat.description}</p>
            </div>
          ))
        )}
      </div>
