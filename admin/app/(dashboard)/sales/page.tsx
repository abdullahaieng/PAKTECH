  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-[var(--muted)] mt-1">Apply or remove discounts on products</p>
      </div>
      ...
      <div className="bg-white rounded-xl border overflow-hidden">
        ...
        {loading ? (
          ...
          <p className="p-8 text-center text-[var(--muted)]">No products on sale yet</p>
        ) : (
          <table className="w-full text-sm">
            <thead className="bg-slate-50 border-b">
              <tr>
                <th className="text-left p-4 font-medium text-[var(--muted)]">Product</th>
                <th className="text-left p-4 font-medium text-[var(--muted)]">Original</th>
                <th className="text-left p-4 font-medium text-[var(--muted)]">Sale Price</th>
                <th className="text-left p-4 font-medium text-[var(--muted)]">Off</th>
                <th className="text-right p-4 font-medium text-[var(--muted)]">Action</th>
              </tr>
            </thead>
              ...
              {saleProducts.map((p) => {
                ...
                return (
                  <tr key={p.id} className="hover:bg-slate-50">
                    ...
                    <td className="p-4 text-[var(--muted)] line-through">{formatPrice(p.price)}</td>
