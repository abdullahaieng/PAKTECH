...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Orders over Rs. 5,000 get free standard shipping across Pakistan. Orders below that amount have a Rs. 250 standard shipping charge.",
  },
  {
    id: "faq-6",
  ...
  },
  {
    ...
    answer: "Follow the process on the warranty card included with your product, or contact our support team. Email: hello@paktech.pk or WhatsApp: +92 300 1234567",
  },
  {
    id: "faq-8",
...
export const teamMembers: TeamMember[] = [
  {
    ...
    name: "Hassan Raza",
    role: "Founder & CEO",
    bio: "Tech enthusiast with 10+ years in Pakistan's electronics industry. Passionate about making premium tech accessible.",
